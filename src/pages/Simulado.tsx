  ...
  useEffect(() => {
    if (started && !finished) {
      ...
      const handleNavigation = () => {
        // If user tries to navigate, show confirmation dialog instead
        window.history.pushState(null, '', window.location.pathname);
        setAttemptToLeave(true);
      };
          ...
          >
            ...
            <CardFooter className="flex justify-center p-6 md:p-8 pt-0">
              ...
              <Button 
                ...
                size="lg"
                className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white font-medium px-10 py-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-blue-500/20 hover:scale-105"
              >
                Iniciar Simulado
          ...
          >
            ...
            <CardFooter className="flex justify-center p-6 md:p-8">
              ...
              <Button 
                ...
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 px-8 py-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-purple-500/20 hover:scale-105"
              >
